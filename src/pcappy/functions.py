...
load_func('pcap_perror', argtypes_=[pcap_t_ptr, c_char_p])
...
load_func('pcap_freecode', argtypes_=[bpf_program_ptr])

load_func('pcap_offline_filter', c_int, [bpf_program_ptr, pcap_pkthdr_ptr, c_char_p])
...
load_func('pcap_free_datalinks', argtypes_=[c_int_p])
...
load_func('pcap_dump_close', argtypes_=[pcap_dumper_t_ptr])
...
load_func('pcap_ng_dump', argtypes_=[pcap_dumper_t_ptr, pcap_pkthdr_ptr, c_char_p])

load_func('pcap_ng_dump_close', argtypes_=[pcap_dumper_t_ptr])
...
load_func('bpf_dump', argtypes_=[bpf_program_ptr, c_int])
